...
extension String{
    /// 计算字符串的尺寸
    public func sf_getTextSize(rectSize: CGSize, fontSize: CGFloat) -> CGSize {
    ...
    /// 根据字符串以及字体->返回文本的尺寸
    public func sf_getTextSize(string: String, font: UIFont,size: CGSize) -> CGSize {
    ...
    public func sf_getTextSize(font:UIFont,width:CGFloat)-> CGSize{
